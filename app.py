...
class Profil(db.Model):
    ...
    nom_entreprise = db.Column(db.String(100), default="Mon Entreprise")
    gerant = db.Column(db.String(100), default="Gérant")
    telephone = db.Column(db.String(20), default="+226")
...
def creer_devis(client_id):
    ...
    if request.method == 'POST':
        ...
        nouvel_article = Materiel(designation=designation, quantite=quantite, prix_unitaire=prix, client_id=client.id)
